...
class LayoutAddDetalhe extends StatelessWidget {
  late ObservadorCampoTexto _observadorCampoTexto;
  late ObservadorButoes _observadorButoes = ObservadorButoes();

  final Function(String nome, int tipo, int tipoProduto)accaoAoFinalizar;
  ...
  LayoutAddDetalhe({this.dado, required this.accaoAoFinalizar}) {
    _observadorCampoTexto = ObservadorCampoTexto();
    _observadorButoes = ObservadorButoes();

    if (dado != null) {
      nome = "${dado?.detalhe}";
      tipoProduto = TipoProduto.paraInteiro(TipoProduto.paraTexto(dado?.tipo??0));
      tipo = TipoDetalhe.paraInteiro(TipoDetalhe.paraTexto(dado?.tipo??0));
    } else {
      nome = "";
    }
  }
        ...
        children: [
              ...
              children: [
                ...
                MenuDropDown(
                  ...
                  metodoChamadoNaInsersao: (dado) {
                    tipoProduto = TipoProduto.paraInteiro(dado);
                  },
                  listaItens: [
          ...
          Padding(
            ...
            child: Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text("Tipo de Detalhe:  "),
                MenuDropDown(
                  labelMenuDropDown: TipoDetalhe.paraTexto(tipo),
                  metodoChamadoNaInsersao: (dado) {
                    tipo = TipoDetalhe.paraInteiro(dado);
                  },
                  listaItens: [
                    TipoDetalhe.paraTexto(0),
                    TipoDetalhe.paraTexto(1),
                    TipoDetalhe.paraTexto(2),
                  ],
                ),
              ],
            ),
                ...
                return Container(
                  ...
                  child: ModeloButao(
                    ...
                    metodoChamadoNoClique: () {
                      accaoAoFinalizar(nome, tipo, tipoProduto);
                    },
                  ),
                );
              }),
