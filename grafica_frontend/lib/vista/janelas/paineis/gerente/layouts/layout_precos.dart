...
import 'package:grafica_frontend/vista/janelas/paineis/gerente/layouts/layout_adicionar_preco.dart';
          ...
          return Column(
            children: List.generate(
                ...
                (indice) => CadaPreco(
                      ...
                      indice: indice,
                      accaoAoEliminar: () {
                          produtosC.removerPrecoProduto(produto, precos[indice], precos, indice);
                      },
                    )),
          );
        }),
